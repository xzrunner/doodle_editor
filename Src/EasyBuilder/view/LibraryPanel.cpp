...
wxgui::LibraryList* LibraryPanel::getActorList() 
{ 
	return m_actorPage->getList(); 
}

wxgui::LibraryList* LibraryPanel::getSceneList() 
{ 
	return m_scenePage->getList(); 
}

wxgui::LibraryList* LibraryPanel::getMediaList() 
{ 
	return m_mediaPage->getList(); 
}

wxgui::LibraryList* LibraryPanel::getBehaviorList() 
{ 
