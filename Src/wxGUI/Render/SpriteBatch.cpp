...
// 		sprite->getMirror(xMirror, yMirror);
// 
// 		f2Vec2 leftLow(0, 0), rightLow(1, 0),
...
// 		}
// 
// 		texCoords.push_back(f2Vec2(leftLow.x, leftLow.y));
// 		texCoords.push_back(f2Vec2(rightLow.x, rightLow.y));
// 		texCoords.push_back(f2Vec2(rightTop.x, rightTop.y));
// 
// 		texCoords.push_back(f2Vec2(leftLow.x, leftLow.y));
// 		texCoords.push_back(f2Vec2(rightTop.x, rightTop.y));
// 		texCoords.push_back(f2Vec2(leftTop.x, leftTop.y));
// 	}
// 
