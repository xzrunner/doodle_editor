...
Joint::Joint(b2World* world, const JointDef& params, const f2Vec2& anchor, 
...
void Joint::initialize(const JointDef& params, const f2Vec2& anchor, b2Body* b0, b2Body* b1, bool isMotor)
{
