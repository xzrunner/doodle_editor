...
#include "Edit/ComposeWholeSkeletonOP.h"
...
void SkeletonEditPanel::traverseSprites(IVisitor& visitor, wxgui::TraverseType type/* = e_allExisting*/,
										bool order/* = true*/) const
{
	m_skeleton->traverse(visitor);
}

void SkeletonEditPanel::removeSprite(f2Sprite* sprite)
{
