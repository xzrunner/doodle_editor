...
void SGI::implement(const std::vector<f2Vec2>& src, 
...
{
	bool bFind = false;
	const f2Vec2& s = tri->nodes[index],
...
void SGI::traversal(Triangle* tri, std::vector<f2Vec2>& strip, int level/* = 0*/)
{
	tri->bUsed = true;
