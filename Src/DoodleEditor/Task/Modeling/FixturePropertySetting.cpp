...
FixturePropertySetting::FixturePropertySetting(wxgui::EditPanel* editPanel, FixtureData* fixture)
	: wxgui::IPropertySetting(editPanel, wxT("Body"))
	, m_fixture(fixture)
{
}

void FixturePropertySetting::updatePanel(wxgui::PropertySettingPanel* panel)
{
...
void FixturePropertySetting::updatePropertyGrid(wxgui::PropertySettingPanel* panel)
{
	updatePanel(panel);
}

void FixturePropertySetting::enablePropertyGrid(wxgui::PropertySettingPanel* panel, bool bEnable)
{
	// 
}