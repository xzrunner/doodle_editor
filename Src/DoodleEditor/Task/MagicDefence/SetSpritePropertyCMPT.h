#ifndef _DEDITOR_MAGIC_DEFENCE_SET_SPRITE_PROPERTY_CMPT_H_
#define _DEDITOR_MAGIC_DEFENCE_SET_SPRITE_PROPERTY_CMPT_H_
...
#endif // _DEDITOR_MAGIC_DEFENCE_SET_SPRITE_PROPERTY_CMPT_H_